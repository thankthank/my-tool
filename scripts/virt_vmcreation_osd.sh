...
OSTEMPLATE="/home/vms/template/jeos15sp1-tem-24G.qcow2"
...
virt-install --name=$VMNAME \
	...
	--disk $VMLOCATION/$VMNAME/os.qcow2 \
       	...
       	--disk $VMLOCATION/$VMNAME/osd3.qcow2 \
       	--disk $VMLOCATION/$VMNAME/osd4.qcow2 \
       	--disk $VMLOCATION/$VMNAME/osd5.qcow2 \
       	--disk $VMLOCATION/$VMNAME/osd6.qcow2 \
       	--disk $VMLOCATION/$VMNAME/osd7.qcow2 \
       	--disk $VMLOCATION/$VMNAME/osd8.qcow2 \
	--import \
